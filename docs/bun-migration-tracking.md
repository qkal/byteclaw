...
#### Pending Tasks
- [ ] Create migration tracking document (this document)
...
- [ ] Create native dependency test script
...
3. **Missing helper scripts**: `scripts/npm-runner.mjs` and `scripts/windows-cmd-helpers.mjs` referenced but not found
...
4. `Dockerfile` (root) - Referenced in docker-build-cache.test.ts
5. `scripts/e2e/Dockerfile` - Referenced in docker-build-cache.test.ts
6. `scripts/e2e/Dockerfile.qr-import` - Referenced in docker-build-cache.test.ts
7. `scripts/docker/cleanup-smoke/Dockerfile` - Referenced in docker-build-cache.test.ts
8. `Dockerfile.sandbox` - Referenced in docker-build-cache.test.ts
9. `Dockerfile.sandbox-browser` - Referenced in docker-build-cache.test.ts
10. `Dockerfile.sandbox-common` - Referenced in docker-build-cache.test.ts
