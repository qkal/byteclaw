...
export const signalMessageActions: ChannelMessageActionAdapter = {
  ...
  handleAction: async ({ action, params, cfg, accountId, toolContext }) => {
    ...
    if (action === "react") {
      ...
      const actionConfig = resolveSignalAccount({ accountId, cfg }).config.actions;
