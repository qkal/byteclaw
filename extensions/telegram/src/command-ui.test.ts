...
describe("telegram command ui", () => {
  it("adds agent id to command pagination callback data when provided", () => {
    ...
    expect(keyboard[0]).toEqual([
      { callback_data: "commands_page_1:agent-main", text: "◀ Prev" },
      { callback_data: "commands_page_noop:agent-main", text: "2/3" },
      { callback_data: "commands_page_3:agent-main", text: "Next ▶" },
    ]);
  });
});
