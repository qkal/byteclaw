...
export function migrateTelegramGroupConfig(params: {
  ...
  const migrationTargets: {
    ...
    { groups: resolveAccountGroups(params.cfg, params.accountId).groups, scope: "account" },
    { groups: params.cfg.channels?.telegram?.groups, scope: "global" },
  ];
  ...
  return { migrated, scopes, skippedExisting };
}
