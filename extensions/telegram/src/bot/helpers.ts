...
import { type NormalizedAllowFrom, firstDefined, normalizeAllowFrom } from "../bot-access.js";
...
export interface TelegramThreadSpec {
  id?: number;
  scope: "dm" | "forum" | "none";
}
...
export async function resolveTelegramGroupAllowFromContext(params: {
  ...
  groupConfig?: TelegramGroupConfig | TelegramDirectConfig;
  topicConfig?: TelegramTopicConfig;
  groupAllowOverride?: (string | number)[];
...
export function buildTelegramParentPeer(params: {
  ...
  return { id: String(params.chatId), kind: "group" };
}
