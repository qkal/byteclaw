...
describe("wrapFileReferencesInHtml", () => {
  ...
  it("handles boundary and punctuation wrapping cases", () => {
    const cases = [
      { contains: undefined, input: "No markdown files here" },
      { contains: "<code>File.md</code>", input: "File.md at start" },
      { contains: "<code>file.md</code>", input: "Ends with file.md" },
      { contains: "<code>README.md</code>.", input: "See README.md." },
      { contains: "<code>README.md</code>,", input: "See README.md," },
      { contains: "(<code>README.md</code>)", input: "(README.md)" },
      { contains: "<code>README.md</code>:", input: "README.md:" },
    ] as const;
