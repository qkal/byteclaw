...
export interface MatrixRelationsPage {
...
export interface MatrixClientEventMap {
...
export interface FileWithThumbnailInfo {
  size?: number;
  mimetype?: string;
...
export interface MatrixSecretStorageStatus {
  ready: boolean;
  defaultKeyId: string | null;
  secretStorageKeyValidityMap?: Record<string, boolean>;
}

export interface MatrixGeneratedSecretStorageKey {
  keyId?: string | null;
  keyInfo?: {
    passphrase?: unknown;
    name?: string;
...
export interface MatrixDeviceVerificationStatusLike {
  isVerified?: () => boolean;
...
export interface MatrixKeyBackupTrustInfo {
  trusted: boolean;
...
export interface MatrixImportRoomKeyProgress {
  stage: string;
  successes?: number;
  failures?: number;
  total?: number;
...
export interface MatrixSecretStorageKeyDescription {
  passphrase?: unknown;
  name?: string;
  [key: string]: unknown;
}

export interface MatrixCryptoCallbacks {
  getSecretStorageKey?: (
...
export interface MatrixStoredRecoveryKey {
  version: 1;
  createdAt: string;
  keyId?: string | null;
  encodedPrivateKey?: string;
...
export interface MatrixCryptoBootstrapApi {
