...
import { type PollInput, normalizePollInput } from "../runtime-api.js";
...
export interface PollParsedAnswer {
  id: string;
  text: string;
}

export interface PollStartSubtype {
...
export interface LegacyPollStartContent {
...
export interface ParsedPollStart {
  question: string;
...
export interface PollResponseSubtype {
  answers: string[];
}
