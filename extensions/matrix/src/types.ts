...
export interface MatrixDmConfig {
...
export interface MatrixActionConfig {
  reactions?: boolean;
  messages?: boolean;
  pins?: boolean;
  profile?: boolean;
...
export interface MatrixThreadBindingsConfig {
  enabled?: boolean;
  idleHours?: number;
  maxAgeHours?: number;
...
export interface MatrixExecApprovalConfig {
...
export interface MatrixNetworkConfig {
