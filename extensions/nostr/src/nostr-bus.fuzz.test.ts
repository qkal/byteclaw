...
import { type MetricName, createMetrics } from "./metrics.js";
...
describe("Metrics fuzz", () => {
  ...
  describe("invalid label values", () => {
    ...
    it("handles very long relay URL", () => {
      const metrics = createPlainMetrics();
      const longUrl = "wss://" + "a".repeat(10_000) + ".com";
      expect(() => {
  ...
  describe("rapid emissions", () => {
    it("handles many rapid emissions", () => {
      ...
      const snapshot = metrics.getSnapshot();
      expect(snapshot.eventsReceived).toBe(10_000);
    });
  });
...
describe("Event shape validation", () => {
  ...
  describe("timestamp edge cases", () => {
    const testTimestamps = [
      { desc: "NaN", value: Number.NaN },
      { desc: "Infinity", value: Infinity },
      { desc: "-Infinity", value: -Infinity },
      { desc: "negative", value: -1 },
      { desc: "zero", value: 0 },
      { desc: "year 10000", value: 253_402_300_800 }, // Far future
      { desc: "year 0001", value: -62_135_596_800 }, // Far past
      { desc: "float", value: 1.5 },
    ];
...
describe("JSON parsing edge cases", () => {
  const malformedJsonCases = [
    ...
    { desc: "null literal", input: "null" },
    { desc: "undefined literal", input: "undefined" },
    { desc: "incomplete object", input: "{" },
    { desc: "incomplete array", input: "[" },
    { desc: "undefined value", input: '{"key": undefined}' },
    { desc: "single quotes", input: "{'key': 'value'}" },
    { desc: "NaN value", input: '{"key": NaN}' },
    { desc: "Infinity value", input: '{"key": Infinity}' },
    { desc: "null byte", input: "\x00" },
    { desc: "plain string", input: "abc" },
    { desc: "plain number", input: "123" },
  ];
