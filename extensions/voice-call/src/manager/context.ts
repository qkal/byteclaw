...
export interface TranscriptWaiter {
...
export interface CallManagerRuntimeState {
...
export interface CallManagerRuntimeDeps {
...
export interface CallManagerTransientState {
