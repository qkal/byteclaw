...
interface DiscordChannelOverrideConfig {
  ...
  autoArchiveDuration?: "60" | "1440" | "4320" | "10080" | 60 | 1440 | 4320 | 10_080;
}

export interface DiscordGuildEntryResolved {
  id?: string;
  slug?: string;
  requireMention?: boolean;
  ignoreOtherMentions?: boolean;
...
export function resolveDiscordMemberAccessState(params: {
  ...
  return { channelRoles, channelUsers, hasAccessRestrictions, memberAllowed } as const;
}
