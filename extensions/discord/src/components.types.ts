...
export interface DiscordComponentButtonSpec {
  label: string;
...
export interface DiscordComponentSelectOption {
  label: string;
  value: string;
  description?: string;
  emoji?: {
...
export interface DiscordComponentSelectSpec {
...
export interface DiscordModalFieldSpec {
...
export interface DiscordModalSpec {
  title: string;
  callbackData?: string;
  triggerLabel?: string;
...
export interface DiscordComponentMessageSpec {
  text?: string;
  reusable?: boolean;
  container?: {
...
export interface DiscordComponentEntry {
  id: string;
...
export interface DiscordModalFieldDefinition {
  id: string;
  name: string;
  label: string;
  type: DiscordComponentModalFieldType;
...
export interface DiscordComponentBuildResult {
