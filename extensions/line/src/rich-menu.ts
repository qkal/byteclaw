...
export function createGridLayout(
  ...
  return [
    { action: actions[0], bounds: { height: rowHeight, width: colWidth, x: 0, y: 0 } },
    { action: actions[1], bounds: { height: rowHeight, width: colWidth, x: colWidth, y: 0 } },
    { action: actions[2], bounds: { height: rowHeight, width: colWidth, x: colWidth * 2, y: 0 } },
    { action: actions[3], bounds: { height: rowHeight, width: colWidth, x: 0, y: rowHeight } },
    {
      action: actions[4],
      bounds: { height: rowHeight, width: colWidth, x: colWidth, y: rowHeight },
    },
    {
      action: actions[5],
      bounds: { height: rowHeight, width: colWidth, x: colWidth * 2, y: rowHeight },
    },
  ];
}
