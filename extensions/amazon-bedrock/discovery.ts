...
interface BedrockDiscoveryCacheEntry {
  expiresAt: number;
...
function includesTextModalities(modalities?: string[]): boolean {
...
function mapInputModalities(summary: BedrockModelSummary): ("text" | "image")[] {
