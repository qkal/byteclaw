...
const REFLECTION_PATTERNS: { re: RegExp; label: string }[] = [
  { label: "internal-separator", re: INTERNAL_SEPARATOR_RE },
  { label: "assistant-role-marker", re: ASSISTANT_ROLE_MARKER_RE },
  { label: "thinking-tag", re: THINKING_TAG_RE },
  { label: "relevant-memories-tag", re: RELEVANT_MEMORIES_TAG_RE },
  { label: "final-tag", re: FINAL_TAG_RE },
];
