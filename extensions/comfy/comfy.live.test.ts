...
interface RegisteredMusicProvider {
  id: string;
...
describeLive("comfy live", () => {
  ...
  it.skipIf(!isComfyCapabilityConfigured({ agentDir, capability: "image", cfg: cfg as never }))(
  ...
  it.skipIf(!isComfyCapabilityConfigured({ agentDir, capability: "video", cfg: cfg as never }))(
  ...
  it.skipIf(!isComfyCapabilityConfigured({ agentDir, capability: "music", cfg: cfg as never }))(
