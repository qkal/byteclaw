...
const STEPFUN_STANDARD_MODEL_CATALOG: readonly ModelDefinitionConfig[] = [
  buildStepFunModel(STEPFUN_DEFAULT_MODEL_ID, "Step 3.5 Flash"),
];

const STEPFUN_PLAN_MODEL_CATALOG: readonly ModelDefinitionConfig[] = [
  buildStepFunModel(STEPFUN_DEFAULT_MODEL_ID, "Step 3.5 Flash"),
  buildStepFunModel(STEPFUN_FLASH_2603_MODEL_ID, "Step 3.5 Flash 2603"),
];

function cloneCatalog(models: readonly ModelDefinitionConfig[]): ModelDefinitionConfig[] {
