...
export interface ZaloSendPhotoParams {
  chat_id: string;
  photo: string;
  caption?: string;
}
...
export interface ZaloSetWebhookParams {
  url: string;
  secret_token: string;
}
...
export async function getMe(
  ...
  return callZaloApi<ZaloBotInfo>("getMe", token, undefined, { fetch: fetcher, timeoutMs });
}
...
export async function getUpdates(
  ...
  return callZaloApi<ZaloUpdate>("getUpdates", token, body, { fetch: fetcher, timeoutMs });
}
