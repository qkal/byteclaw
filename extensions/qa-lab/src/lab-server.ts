...
import { type QaBusState, createQaBusState } from "./bus-state.js";
...
import { type OpenClawConfig, qaChannelPlugin, setQaChannelRuntime } from "./runtime-api.js";
import { readQaBootstrapScenarioCatalog } from "./scenario-catalog.js";
import { type QaSelfCheckResult, runQaSelfCheckAgainstState } from "./self-check.js";

interface QaLabBootstrapDefaults {
...
export async function startQaLabServer(
  ...
  if (embeddedGatewayEnabled) {
    gateway = await startQaGatewayLoop({ baseUrl: listenUrl, state });
  }
