...
export interface NormalizedWebhookReaction {
...
const REACTION_TYPE_MAP = new Map<number, { emoji: string; action: "added" | "removed" }>([
  [2000, { action: "added", emoji: "❤️" }],
  [2001, { action: "added", emoji: "👍" }],
  [2002, { action: "added", emoji: "👎" }],
  [2003, { action: "added", emoji: "😂" }],
  [2004, { action: "added", emoji: "‼️" }],
  [2005, { action: "added", emoji: "❓" }],
  [3000, { action: "removed", emoji: "❤️" }],
  [3001, { action: "removed", emoji: "👍" }],
  [3002, { action: "removed", emoji: "👎" }],
  [3003, { action: "removed", emoji: "😂" }],
  [3004, { action: "removed", emoji: "‼️" }],
  [3005, { action: "removed", emoji: "❓" }],
]);
...
const TAPBACK_TEXT_MAP = new Map<string, { emoji: string; action: "added" | "removed" }>([
  ["loved", { action: "added", emoji: "❤️" }],
  ["liked", { action: "added", emoji: "👍" }],
  ["disliked", { action: "added", emoji: "👎" }],
  ["laughed at", { action: "added", emoji: "😂" }],
  ["emphasized", { action: "added", emoji: "‼️" }],
  ["questioned", { action: "added", emoji: "❓" }],
  // Removal patterns (e.g., "Removed a heart from")
  ["removed a heart from", { action: "removed", emoji: "❤️" }],
  ["removed a like from", { action: "removed", emoji: "👍" }],
  ["removed a dislike from", { action: "removed", emoji: "👎" }],
  ["removed a laugh from", { action: "removed", emoji: "😂" }],
  ["removed an emphasis from", { action: "removed", emoji: "‼️" }],
  ["removed a question from", { action: "removed", emoji: "❓" }],
]);
...
export function resolveTapbackContext(message: NormalizedWebhookMessage): {
  ...
  return { actionHint, emojiHint, replyToId };
}
