...
import { type CardHeaderConfig, sendMessageFeishu, sendStructuredCardFeishu } from "./send.js";
import { FeishuStreamingSession, mergeStreamingText } from "./streaming-card.js";
import { resolveReceiveIdType } from "./targets.js";
import { type TypingIndicatorState, addTypingIndicator, removeTypingIndicator } from "./typing.js";
...
export function createFeishuReplyDispatcher(params: CreateFeishuReplyDispatcherParams) {
  ...
  const prefixContext = createReplyPrefixContext({ agentId, cfg });
