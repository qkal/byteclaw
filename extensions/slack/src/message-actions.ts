...
import { type ChannelToolSend, extractToolSend } from "openclaw/plugin-sdk/tool-send";
...
export function listSlackMessageActions(
  ...
  const accounts = (
    accountId ? [resolveSlackAccount({ accountId, cfg })] : listEnabledSlackAccounts(cfg)
