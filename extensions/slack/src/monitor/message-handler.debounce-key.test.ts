...
describe("buildSlackDebounceKey", () => {
  ...
  it("returns null when message has no sender", () => {
    const msg = makeMessage({ bot_id: undefined, user: undefined });
