...
describe("resolveWhatsAppHeartbeatRecipients", () => {
  ...
  function setSingleUnauthorizedSessionWithAllowFrom() {
    setSessionStore({
      a: { lastChannel: "whatsapp", lastTo: "+15550000099", sessionId: "a", updatedAt: 2 },
    });
  ...
  it("uses allowFrom store recipients when session recipients are ambiguous", () => {
    setSessionStore({
      a: { lastChannel: "whatsapp", lastTo: "+15550000001", sessionId: "a", updatedAt: 2 },
      b: { lastChannel: "whatsapp", lastTo: "+15550000002", sessionId: "b", updatedAt: 1 },
    });
    setAllowFromStore(["+15550000001"]);
  ...
  it("returns all authorized session recipients when allowFrom matches multiple", () => {
    setSessionStore({
      a: { lastChannel: "whatsapp", lastTo: "+15550000001", sessionId: "a", updatedAt: 2 },
      b: { lastChannel: "whatsapp", lastTo: "+15550000002", sessionId: "b", updatedAt: 1 },
      c: { lastChannel: "whatsapp", lastTo: "+15550000003", sessionId: "c", updatedAt: 0 },
    });
  ...
  it("uses the requested account allowFrom config and pairing store", () => {
    setSessionStore({
      a: { lastChannel: "whatsapp", lastTo: "+15550000077", sessionId: "a", updatedAt: 2 },
    });
