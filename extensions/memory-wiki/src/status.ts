...
import { type WikiPageKind, inferWikiPageKind, toWikiPageSummary } from "./markdown.js";
import { probeObsidianCli } from "./obsidian.js";

export interface MemoryWikiStatusWarning {
  code:
    | "vault-missing"
...
export interface MemoryWikiDoctorFix {
  code: MemoryWikiStatusWarning["code"];
  message: string;
}

export interface MemoryWikiDoctorReport {
  healthy: boolean;
  warningCount: number;
...
interface ResolveMemoryWikiStatusDeps {
