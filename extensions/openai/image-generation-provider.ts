      ...
      try {
        ...
        const images = (data.data ?? [])
          .map((entry, index) => {
            ...
            return Object.assign({buffer:Buffer.from(entry.b64_json,`base64`),mimeType:DEFAULT_OUTPUT_MIME,fileName:`image-${index+1}.png`}, entry.revised_prompt?{revisedPrompt:entry.revised_prompt}:{});
          })
