...
describe("openai tts", () => {
  ...
  describe("isValidOpenAIModel", () => {
    it("matches the supported model set and rejects unsupported values", () => {
      ...
      const cases = [
        { expected: true, model: "gpt-4o-mini-tts" },
        { expected: true, model: "tts-1" },
        { expected: true, model: "tts-1-hd" },
        { expected: false, model: "invalid" },
        { expected: false, model: "" },
        { expected: false, model: "gpt-4" },
      ] as const;
