...
export function createCommandHandlers(context: CommandHandlerContext) {
    ...
    try {
      ...
      openSelector(selector, async (value) => {
        try {
          ...
          chatLog.addSystem(`model set failed: ${String(error)}`);
        }
      });
    } catch (error) {
      chatLog.addSystem(`model list failed: ${String(error)}`);
      tui.requestRender();
    }
  };
  ...
  const openSessionSelector = async () => {
    try {
      ...
      chatLog.addSystem(`sessions list failed: ${String(error)}`);
      tui.requestRender();
    }
  };
    ...
    switch (name) {
      ...
      case "gateway-status": {
        try {
          ...
          chatLog.addSystem(`status failed: ${String(error)}`);
        }
        break;
      }
      case "agent": {
      ...
      case "think": {
        ...
        try {
          ...
          chatLog.addSystem(`think failed: ${String(error)}`);
        }
        break;
      }
      case "verbose": {
        ...
        try {
          ...
          chatLog.addSystem(`verbose failed: ${String(error)}`);
        }
        break;
      }
      case "fast": {
        ...
        try {
          ...
          chatLog.addSystem(`fast failed: ${String(error)}`);
        }
        break;
      }
      case "reasoning": {
        ...
        try {
          ...
          chatLog.addSystem(`reasoning failed: ${String(error)}`);
        }
        break;
      }
      case "usage": {
        ...
        try {
          ...
          chatLog.addSystem(`usage failed: ${String(error)}`);
        }
        break;
      }
      case "elevated": {
        ...
        try {
          ...
          chatLog.addSystem(`elevated failed: ${String(error)}`);
        }
        break;
      }
      case "activation": {
        ...
        try {
          ...
          chatLog.addSystem(`activation failed: ${String(error)}`);
        }
        break;
      }
      case "new": {
        try {
          ...
          chatLog.addSystem(`new session failed: ${sanitizeRenderableText(String(error))}`);
        }
        break;
      }
      case "reset": {
        try {
          ...
          chatLog.addSystem(`reset failed: ${sanitizeRenderableText(String(error))}`);
        }
        break;
      }
      case "abort": {
  ...
  const sendMessage = async (text: string) => {
    ...
    try {
      ...
      chatLog.addSystem(`${isBtw ? "btw failed" : "send failed"}: ${String(error)}`);
      if (!isBtw) {
