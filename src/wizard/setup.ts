...
export async function runSetupWizard(
  ...
  let flow: WizardFlow =
    ...
    (await prompter.select({
      ...
      message: "Setup mode",
      options: [
        { hint: quickstartHint, label: "QuickStart", value: "quickstart" },
        { hint: manualHint, label: "Manual", value: "advanced" },
      ],
    }));
  ...
  if (snapshot.exists) {
    ...
    const action = await prompter.select({
      ...
      options: [
        { label: "Use existing values", value: "keep" },
        { label: "Update values", value: "modify" },
