      ...
      .action(async (opts: DevicesRpcOpts) => {
        ...
        if (list.pending?.length) {
          ...
          defaultRuntime.log(
            renderTable({
              columns: [
                { header: "Request", key: "Request", minWidth: 10 },
                { flex: true, header: "Device", key: "Device", minWidth: 16 },
                { header: "Role", key: "Role", minWidth: 8 },
                { flex: true, header: "Scopes", key: "Scopes", minWidth: 14 },
                { header: "IP", key: "IP", minWidth: 12 },
                { header: "Age", key: "Age", minWidth: 8 },
                { header: "Flags", key: "Flags", minWidth: 8 },
              ],
        ...
        if (list.paired?.length) {
          ...
          defaultRuntime.log(
            renderTable({
              columns: [
                { flex: true, header: "Device", key: "Device", minWidth: 16 },
                { flex: true, header: "Roles", key: "Roles", minWidth: 12 },
                { flex: true, header: "Scopes", key: "Scopes", minWidth: 12 },
                { flex: true, header: "Tokens", key: "Tokens", minWidth: 12 },
                { header: "IP", key: "IP", minWidth: 12 },
              ],
