...
describe("argv helpers", () => {
  ...
  it.each([
    { expected: false, path: ["status"] },
    { expected: false, path: ["update", "status"] },
    { expected: false, path: ["config", "get"] },
    { expected: false, path: ["models", "status"] },
    { expected: true, path: ["agents", "list"] },
