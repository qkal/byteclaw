...
import { type SecretsApplyPlan, isSecretsApplyPlan } from "../secrets/plan.js";
import { formatDocsLink } from "../terminal/links.js";
import { theme } from "../terminal/theme.js";
import { type GatewayRpcOpts, addGatewayClientOptions, callGatewayFromCli } from "./gateway-rpc.js";

type SecretsReloadOptions = GatewayRpcOpts & { json?: boolean };
interface SecretsAuditOptions {
  check?: boolean;
  json?: boolean;
  allowExec?: boolean;
}
interface SecretsConfigureOptions {
  apply?: boolean;
  yes?: boolean;
  planOut?: string;
