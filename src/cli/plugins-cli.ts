...
export interface PluginMarketplaceListOptions {
  json?: boolean;
}
        ...
        defaultRuntime.log(
          renderTable({
            columns: [
              ...
              { header: "Format", key: "Format", minWidth: 9 },
              { header: "Status", key: "Status", minWidth: 10 },
              { flex: true, header: "Source", key: "Source", minWidth: 26 },
        ...
        defaultRuntime.log(
          renderTable({
            columns: [
              ...
              { flex: true, header: "ID", key: "ID", minWidth: 10 },
              { header: "Status", key: "Status", minWidth: 10 },
              { header: "Shape", key: "Shape", minWidth: 18 },
              { flex: true, header: "Capabilities", key: "Capabilities", minWidth: 28 },
              { flex: true, header: "Compatibility", key: "Compatibility", minWidth: 24 },
              { flex: true, header: "Bundle", key: "Bundle", minWidth: 14 },
              { flex: true, header: "Hooks", key: "Hooks", minWidth: 20 },
            ],
            rows,
            width: tableWidth,
          }).trimEnd(),
  ...
  plugins
    ...
    .action(
      async (
        ...
        await runPluginInstallCommand({ opts, raw });
      },
    );
