...
interface ParsedQmdSessionScope {
  channel?: string;
...
function parseQmdSessionScope(key?: string): ParsedQmdSessionScope {
  ...
  if (normalized.includes(":group:")) {
    return { chatType: "group", normalizedKey: normalized };
  }
  if (normalized.includes(":channel:")) {
    return { chatType: "channel", normalizedKey: normalized };
  }
  return { chatType: "direct", normalizedKey: normalized };
}
