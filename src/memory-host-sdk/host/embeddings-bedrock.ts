...
const MODELS: Record<string, ModelSpec> = {
  ...
  "amazon.titan-embed-g1-text-02": { dims: 1536, family: "titan-v1", maxTokens: 8000 },
  "amazon.titan-embed-image-v1": { dims: 1024, family: "titan-v1", maxTokens: 128 },
  "amazon.titan-embed-text-v1": { dims: 1536, family: "titan-v1", maxTokens: 8000 },
  ...
  "cohere.embed-english-v3": { dims: 1024, family: "cohere-v3", maxTokens: 512 },
  "cohere.embed-multilingual-v3": { dims: 1024, family: "cohere-v3", maxTokens: 512 },
  "cohere.embed-v4:0": {
    dims: 1536,
    family: "cohere-v4",
    maxTokens: 128_000,
  ...
  "twelvelabs.marengo-embed-2-7-v1:0": { dims: 1024, family: "twelvelabs", maxTokens: 512 },
  "twelvelabs.marengo-embed-3-0-v1:0": { dims: 512, family: "twelvelabs", maxTokens: 512 },
};
...
function buildCohereBody(
  ...
  const body: Record<string, unknown> = { input_type: inputType, texts, truncate: "END" };
  if (family === "cohere-v4") {
...
export function resolveBedrockEmbeddingClient(
  ...
  return { dimensions, model, region };
}
