      ...
      buildGeminiEmbeddingRequest({
        input: {
          parts: [
            ...
            { data: "abc123", mimeType: "image/png", type: "inline-data" },
          ],
...
describe("gemini-embedding-2-preview provider", () => {
      ...
      provider.embedBatchInputs?.([
        {
          parts: [
            { text: "Image file: diagram.png", type: "text" },
            { data: "img", mimeType: "image/png", type: "inline-data" },
          ],
          text: "Image file: diagram.png",
        },
      ]),
  ...
  it("supports multimodal embedBatchInputs requests", async () => {
    ...
    await provider.embedBatchInputs?.([
      ...
      {
        parts: [
          { text: "Audio file: note.wav", type: "text" },
          { data: "aud", mimeType: "audio/wav", type: "inline-data" },
        ],
    ...
    expect(body.requests).toEqual([
      ...
      },
      {
        content: {
          parts: [
            { text: "Audio file: note.wav" },
            { inlineData: { data: "aud", mimeType: "audio/wav" } },
          ],
        },
        model: "models/gemini-embedding-2-preview",
        outputDimensionality: 3072,
