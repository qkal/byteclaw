...
export interface MemoryDreamingExecutionConfig {
...
export interface MemoryDreamingStorageConfig {
  mode: MemoryDreamingStorageMode;
  separateReports: boolean;
}

export interface MemoryLightDreamingConfig {
  enabled: boolean;
  cron: string;
  lookbackDays: number;
  limit: number;
...
export interface MemoryDeepDreamingRecoveryConfig {
  enabled: boolean;
...
export interface MemoryDeepDreamingConfig {
  enabled: boolean;
  cron: string;
  limit: number;
  minScore: number;
...
export interface MemoryRemDreamingConfig {
  enabled: boolean;
  cron: string;
  lookbackDays: number;
  limit: number;
...
export interface MemoryDreamingWorkspace {
  workspaceDir: string;
  agentIds: string[];
}
...
export function resolveMemoryDreamingWorkspaces(cfg: OpenClawConfig): MemoryDreamingWorkspace[] {
  ...
  for (const agentId of agentIds) {
    ...
    byWorkspace.set(key, { agentIds: [agentId], workspaceDir });
  }
