...
const loadPluginManifestRegistryMock = vi.fn(() => ({
  plugins: [
    { contracts: { speechProviders: [{}] }, id: "elevenlabs", origin: "bundled" },
    { contracts: { speechProviders: [{}] }, id: "microsoft", origin: "bundled" },
    { contracts: { speechProviders: [{}] }, id: "openai", origin: "bundled" },
  ],
}));
