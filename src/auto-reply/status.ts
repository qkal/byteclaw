...
interface StatusArgs {
  ...
  timeLine?: string;
  queue?: QueueStatus;
  mediaDecisions?: readonly MediaUnderstandingDecision[];
...
const formatMediaUnderstandingLine = (decisions?: readonly MediaUnderstandingDecision[]) => {
