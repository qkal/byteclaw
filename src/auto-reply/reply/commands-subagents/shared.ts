...
import { type ChatMessage, extractMessageText } from "../commands-subagents-text.js";
...
export function resolveRequesterSessionKey(
  ...
  return resolveInternalSessionKey({ alias, key: raw, mainKey });
}
...
export function loadSubagentSessionEntry(
  ...
  return { entry: store[childKey], store, storePath };
}
