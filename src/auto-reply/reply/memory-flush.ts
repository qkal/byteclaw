...
import { type SessionEntry, resolveFreshSessionTotalTokens } from "../../config/sessions.js";
...
>(params: {
  ...
  return { entry: params.entry, threshold, totalTokens };
}
 ...
 */
export function computeContextHash(messages: { role?: string; content?: unknown }[]): string {
