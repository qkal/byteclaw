...
export interface SpeechProviderContractEntry {
  pluginId: string;
  provider: SpeechProviderPlugin;
}

export interface MediaUnderstandingProviderContractEntry {
  pluginId: string;
  provider: MediaUnderstandingProviderPlugin;
}

export interface RealtimeVoiceProviderContractEntry {
  pluginId: string;
  provider: RealtimeVoiceProviderPlugin;
}

export interface RealtimeTranscriptionProviderContractEntry {
  pluginId: string;
  provider: RealtimeTranscriptionProviderPlugin;
}

export interface ImageGenerationProviderContractEntry {
  pluginId: string;
  provider: ImageGenerationProviderPlugin;
}

export interface VideoGenerationProviderContractEntry {
  pluginId: string;
  provider: VideoGenerationProviderPlugin;
}

export interface MusicGenerationProviderContractEntry {
  pluginId: string;
...
function loadVitestCapabilityContractEntries<T>(params: {
  ...
  pickEntries: (registry: ReturnType<typeof loadBundledCapabilityRuntimeRegistry>) => {
    pluginId: string;
    provider: T;
  }[];
}): { pluginId: string; provider: T }[] {
