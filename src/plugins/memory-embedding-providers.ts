...
export interface MemoryEmbeddingBatchChunk {
  text: string;
  embeddingInput?: EmbeddingInput;
}

export interface MemoryEmbeddingBatchOptions {
  agentId: string;
...
export interface MemoryEmbeddingProviderRuntime {
  id: string;
...
export interface MemoryEmbeddingProviderCreateOptions {
...
export interface MemoryEmbeddingProviderCreateResult {
...
export interface RegisteredMemoryEmbeddingProvider {
...
export function listRegisteredMemoryEmbeddingProviders(): RegisteredMemoryEmbeddingProvider[] {
  return [...getMemoryEmbeddingProviders().values()];
}
