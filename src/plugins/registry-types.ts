...
export interface PluginChannelSetupRegistration {
  pluginId: string;
  pluginName?: string;
  plugin: ChannelPlugin;
  source: string;
...
export interface PluginCliBackendRegistration {
  pluginId: string;
  pluginName?: string;
...
export interface PluginReloadRegistration {
  pluginId: string;
  pluginName?: string;
...
export interface PluginNodeHostCommandRegistration {
  pluginId: string;
  pluginName?: string;
...
export interface PluginSecurityAuditCollectorRegistration {
  pluginId: string;
  pluginName?: string;
...
export interface PluginConversationBindingResolvedHandlerRegistration {
  pluginId: string;
  pluginName?: string;
  pluginRoot?: string;
