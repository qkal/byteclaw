...
export interface TranscriptRewriteReplacement {
...
export interface TranscriptRewriteResult {
...
export interface ContextEnginePromptCacheUsage {
  input?: number;
  output?: number;
  cacheRead?: number;
  cacheWrite?: number;
...
export interface ContextEnginePromptCacheObservationChange {
  code: ContextEnginePromptCacheObservationChangeCode;
  detail: string;
}

export interface ContextEnginePromptCacheObservation {
  broke: boolean;
...
export interface ContextEnginePromptCacheInfo {
