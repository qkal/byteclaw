...
import { type ParsedAgentSessionKey, parseAgentSessionKey } from "../sessions/session-key-utils.js";
...
export function resolveThreadSessionKeys(params: {
  ...
  if (!threadId) {
    return { parentSessionKey: undefined, sessionKey: params.baseSessionKey };
  }
  ...
  return { parentSessionKey: params.parentSessionKey, sessionKey };
}
