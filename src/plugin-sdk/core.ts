...
let cachedSdkChatChannelMeta: ReturnType<typeof buildChatChannelMetaById> | undefined;
...
interface DefineChannelPluginEntryOptions<TPlugin = ChannelPlugin> {
  id: string;
  name: string;
  description: string;
  plugin: TPlugin;
...
interface DefinedChannelPluginEntry<TPlugin> {
  id: string;
  name: string;
  description: string;
...
interface CreateChannelPluginBaseOptions<TResolvedAccount> {
...
interface ChatChannelSecurityOptions<TResolvedAccount extends { accountId?: string | null }> {
  dm: {
    channelKey: string;
    resolvePolicy: (account: TResolvedAccount) => string | null | undefined;
    resolveAllowFrom: (account: TResolvedAccount) => (string | number)[] | null | undefined;
...
interface ChatChannelPairingOptions {
  text: {
    idLabel: string;
    message: string;
    normalizeAllowEntry?: ChannelPairingAdapter["normalizeAllowEntry"];
...
interface ChatChannelAttachedOutboundOptions {
