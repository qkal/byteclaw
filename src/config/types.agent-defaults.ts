...
export interface AgentModelEntryConfig {
  alias?: string;
...
export interface AgentModelListConfig {
  primary?: string;
  fallbacks?: string[];
}

export interface AgentContextPruningConfig {
  mode?: "off" | "cache-ttl";
...
export interface AgentCompactionQualityGuardConfig {
...
export interface AgentCompactionMemoryFlushConfig {
