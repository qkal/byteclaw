...
const PREFIX_RULES: { prefix: string; tags: ConfigTag[] }[] = [
...
const KEYWORD_RULES: { pattern: RegExp; tags: ConfigTag[] }[] = [
...
function normalizeTags(tags: readonly string[]): ConfigTag[] {
...
function collectUnknownTags(tags: readonly string[]): string[] {
...
function addTags(set: Set<ConfigTag>, tags: readonly ConfigTag[]): void {
  for (const tag of tags) {
    set.add(tag);
  }
}
