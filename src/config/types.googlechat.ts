...
export interface GoogleChatDmConfig {
...
export interface GoogleChatGroupConfig {
...
export interface GoogleChatActionConfig {
  reactions?: boolean;
}

export interface GoogleChatAccountConfig {
