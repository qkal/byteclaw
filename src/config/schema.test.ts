...
import { CONFIG_TAGS, applyDerivedTags, deriveTagsForPath } from "./schema.tags.js";
...
describe("config schema", () => {
  ...
  beforeAll(() => {
    ...
    cachedMergeInput = {
      channels: [
        {
          configSchema: { properties: { accessToken: { type: "string" } }, type: "object" },
          id: "matrix",
          label: "Matrix",
        },
      ],
      plugins: [
        {
          configSchema: { properties: { provider: { type: "string" } }, type: "object" },
          id: "voice-call",
          name: "Voice Call",
        },
      ],
