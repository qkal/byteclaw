...
export interface StatusReactionsEmojiConfig {
  thinking?: string;
  tool?: string;
  coding?: string;
  web?: string;
...
export interface StatusReactionsTimingConfig {
...
export interface StatusReactionsConfig {
 ...
 */
export type CommandAllowFrom = Record<string, (string | number)[]>;
...
export interface ProviderCommandsConfig {
