...
export interface MediaUnderstandingScopeMatch {
  channel?: string;
  chatType?: ChatType;
  keyPrefix?: string;
}

export interface MediaUnderstandingScopeRule {
  action: SessionSendPolicyAction;
  match?: MediaUnderstandingScopeMatch;
}

export interface MediaUnderstandingScopeConfig {
...
export interface MediaUnderstandingAttachmentsConfig {
...
interface MediaProviderRequestConfig {
...
export interface LinkModelConfig {
...
export interface LinkToolsConfig {
...
export interface ToolLoopDetectionDetectorConfig {
