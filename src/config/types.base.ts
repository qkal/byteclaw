...
export interface WebReconnectConfig {
  initialMs?: number;
  maxMs?: number;
  factor?: number;
  jitter?: number;
...
export type AgentElevatedAllowFromConfig = Partial<Record<string, (string | number)[]>>;
