...
export const DEFAULT_BRIDGE_PORT = 18_790;
export const DEFAULT_BROWSER_CONTROL_PORT = 18_791;
export const DEFAULT_CANVAS_HOST_PORT = 18_793;
export const DEFAULT_BROWSER_CDP_PORT_RANGE_START = 18_800;
export const DEFAULT_BROWSER_CDP_PORT_RANGE_END = 18_899;
