...
export interface WideAreaDiscoveryConfig {
  enabled?: boolean;
...
export interface GatewayHttpChatCompletionsConfig {
  /**
...
export interface GatewayHttpChatCompletionsImagesConfig {
...
export interface GatewayHttpResponsesConfig {
  /**
...
export interface GatewayHttpResponsesFilesConfig {
...
export interface GatewayHttpResponsesPdfConfig {
...
export interface GatewayHttpResponsesImagesConfig {
...
export interface GatewayHttpSecurityHeadersConfig {
  /**
...
export interface GatewayPushApnsRelayConfig {
...
export interface GatewayPushApnsConfig {
  relay?: GatewayPushApnsRelayConfig;
}

export interface GatewayPushConfig {
  apns?: GatewayPushApnsConfig;
}

export interface GatewayNodesConfig {
...
export interface GatewayWebchatConfig {
