...
export interface SessionAcpIdentity {
...
export interface SessionCompactionTranscriptReference {
  sessionId: string;
  sessionFile?: string;
  leafId?: string;
  entryId?: string;
...
export interface SessionPluginDebugEntry {
  pluginId: string;
  lines: string[];
}
...
interface MergeSessionEntryOptions {
