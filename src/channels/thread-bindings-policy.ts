...
interface SessionThreadBindingsConfigShape {
  enabled?: unknown;
  idleHours?: unknown;
  maxAgeHours?: unknown;
...
interface ChannelThreadBindingsContainerShape {
...
export interface ThreadBindingSpawnPolicy {
  channel: string;
  accountId: string;
  enabled: boolean;
...
interface ThreadBindingLifecycleRecord {
  boundAt: number;
