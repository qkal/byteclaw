 ...
 */
export interface ChannelMessageActionDiscoveryContext {
  cfg: OpenClawConfig;
...
export interface ChannelLegacyStateMigrationPlan {
  kind: "copy" | "move";
  label: string;
  sourcePath: string;
  targetPath: string;
...
export interface ChannelReplyTransport {
  replyToId?: string | null;
  threadId?: string | number | null;
}

export interface ChannelFocusedBindingContext {
...
export interface BaseProbeResult<TError = string | null> {
  ok: boolean;
  error?: TError;
}
