...
export function composeWarningCollectors<Params>(
  ...collectors: (WarningCollector<Params> | null | undefined)[]
...
>(
  ...
  return projectWarningCollector(
    (params) => ({ accountId: params.accountId, cfg: params.cfg }),
    collector,
  );
}
...
export function createConditionalWarningCollector<Params>(
  ...collectors: ((params: Params) => string | string[] | null | undefined | false)[]
): WarningCollector<Params> {
  return (params) =>
...
>(
  ...
  ...collectors: ((account: ResolvedAccount) => string | string[] | null | undefined | false)[]
): WarningCollector<Params> {
