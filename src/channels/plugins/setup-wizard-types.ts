...
export interface PromptAccountIdParams {
  cfg: OpenClawConfig;
...
export interface ChannelOnboardingPostWriteContext {
...
export interface ChannelOnboardingPostWriteHook {
  channel: ChannelId;
  accountId: string;
...
export interface ChannelSetupDmPolicy {
  label: string;
  channel: ChannelId;
  policyKey: string;
  allowFromKey: string;
