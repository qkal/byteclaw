...
export interface ChannelApprovalForwardTarget {
  channel: string;
  to: string;
...
export interface ChannelCapabilitiesDisplayLine {
  text: string;
  tone?: ChannelCapabilitiesDisplayTone;
}

export interface ChannelCapabilitiesDiagnostics {
...
export interface ChannelSecretsAdapter {
...
export interface ChannelOutboundTargetRef {
  channel: string;
  to: string;
  accountId?: string | null;
  threadId?: string | number | null;
...
export interface ChannelStatusAdapter<ResolvedAccount, Probe = unknown, Audit = unknown> {
...
interface ChannelDirectorySelfParams {
  cfg: OpenClawConfig;
  accountId?: string | null;
  runtime: RuntimeEnv;
}
...
interface ChannelDirectoryListGroupMembersParams {
  cfg: OpenClawConfig;
  accountId?: string | null;
  groupId: string;
  limit?: number | null;
...
export interface ChannelDoctorConfigMutation {
  config: OpenClawConfig;
  changes: string[];
  warnings?: string[];
}
...
export interface ChannelDoctorSequenceResult {
  changeNotes: string[];
  warningNotes: string[];
}

export interface ChannelDoctorEmptyAllowlistAccountContext {
...
export interface ChannelApprovalDeliveryAdapter {
...
export interface ChannelApprovalNativeTarget {
  to: string;
  threadId?: string | number | null;
}
...
export interface ChannelApprovalNativeDeliveryCapabilities {
  enabled: boolean;
...
export interface ChannelApprovalNativeAdapter {
...
export interface ChannelApprovalRenderAdapter {
  exec?: {
...
export interface ChannelAllowlistAdapter {
  ...
  readConfig?: (params: { cfg: OpenClawConfig; accountId?: string | null }) =>
    | {
        dmAllowFrom?: (string | number)[];
        groupAllowFrom?: (string | number)[];
        dmPolicy?: string;
        groupPolicy?: string;
        groupOverrides?: { label: string; entries: Array<string | number> }[];
      }
    | Promise<{
        dmAllowFrom?: (string | number)[];
        groupAllowFrom?: (string | number)[];
  ...
  resolveNames?: (params: {
    ...
    | { input: string; resolved: boolean; name?: string | null }[]
    | Promise<{ input: string; resolved: boolean; name?: string | null }[]>;
  supportsScope?: (params: { scope: "dm" | "group" | "all" }) => boolean;
}

export interface ChannelConfiguredBindingConversationRef {
...
export interface ChannelCommandConversationContext {
  accountId: string;
  threadId?: string;
...
export interface ChannelConversationBindingSupport {
