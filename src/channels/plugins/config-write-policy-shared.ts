...
interface AccountConfigWithWrites {
  configWrites?: boolean;
}

interface ChannelConfigWithAccounts {
  configWrites?: boolean;
  accounts?: Record<string, AccountConfigWithWrites>;
}

export interface ConfigWriteScopeLike<TChannelId extends string = string> {
...
export function resolveExplicitConfigWriteTargetShared<TChannelId extends string>(
  ...
  return { kind: "account", scope: { accountId, channelId: scope.channelId } };
}
