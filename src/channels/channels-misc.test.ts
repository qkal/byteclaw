...
describe("normalizeChatType", () => {
  it.each([
    { expected: "direct", name: "normalizes direct", value: "direct" },
    { expected: "direct", name: "normalizes dm alias", value: "dm" },
    { expected: "group", name: "normalizes group", value: "group" },
    { expected: "channel", name: "normalizes channel", value: "channel" },
    { expected: undefined, name: "returns undefined for undefined", value: undefined },
    { expected: undefined, name: "returns undefined for empty", value: "" },
    { expected: undefined, name: "returns undefined for unknown value", value: "nope" },
    { expected: undefined, name: "returns undefined for unsupported room", value: "room" },
  ] satisfies { name: string; value: string | undefined; expected: string | undefined }[])(
    "$name",
    ({ value, expected }) => {
