...
import { type ToolModelConfig, coerceToolModelConfig } from "./model-config.helpers.js";
...
export function decodeDataUrl(
  ...
  return { buffer, kind: "image", mimeType };
}
...
export function resolveProviderVisionModelFromConfig(params: {
  ...
  const providerCfg = findNormalizedProviderValue(
    ...
    params.provider,
  ) as unknown as { models?: { id?: string; input?: string[] }[] } | undefined;
