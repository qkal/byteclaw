...
describe("sanitizeUserFacingText", () => {
  ...
  it.each([
    { expected: "Hello there!", input: "\n\nHello there!" },
    { expected: "Hello there!", input: "\nHello there!" },
    { expected: "Multiple newlines", input: "\n\n\nMultiple newlines" },
...
describe("stripThoughtSignatures", () => {
  ...
  it("removes msg_-prefixed thought_signature from content blocks", () => {
    const input = [
      ...
      { thinking: "test", thought_signature: "AQID", type: "thinking" },
    ];
  ...
  it("handles mixed blocks with and without thought_signature", () => {
    const input = [
      { text: "hello", thought_signature: "msg_abc", type: "text" },
      { arguments: {}, id: "call_1", name: "read", type: "toolCall" },
      { thinking: "hmm", thought_signature: "msg_xyz", type: "thinking" },
    ];
    const result = stripThoughtSignatures(input);
  ...
  it("handles null/undefined blocks in array", () => {
    const input = [null, undefined, { text: "hello", type: "text" }];
    const result = stripThoughtSignatures(input);
    expect(result).toEqual([null, undefined, { text: "hello", type: "text" }]);
  });
});
