...
export interface ToolCallInputRepairReport {
  messages: AgentMessage[];
  droppedToolCalls: number;
  droppedAssistantMessages: number;
}

export interface ToolCallInputRepairOptions {
  allowedToolNames?: Iterable<string>;
}

export type ErroredAssistantResultPolicy = "preserve" | "drop";

export interface ToolUseResultPairingOptions {
...
export interface ToolUseRepairReport {
  messages: AgentMessage[];
  added: Extract<AgentMessage, { role: "toolResult" }>[];
...
export function repairToolUseResultPairing(
  ...
  const out: AgentMessage[] = [];
  const added: Extract<AgentMessage, { role: "toolResult" }>[] = [];
