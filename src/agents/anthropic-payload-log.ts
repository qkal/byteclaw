...
import { type QueuedFileWriter, getQueuedFileWriter } from "./queued-file-writer.js";

type PayloadLogStage = "request" | "usage";

interface PayloadLogEvent {
  ts: string;
...
export interface AnthropicPayloadLogger {
  enabled: true;
...
export function createAnthropicPayloadLogger(params: {
  ...
  return { enabled: true, recordUsage, wrapStreamFn };
}
