...
import { type ParsedAgentSessionKey, parseAgentSessionKey } from "../routing/session-key.js";
...
export interface BuiltSubagentList {
  total: number;
...
export interface SessionEntryResolution {
  storePath: string;
