...
export interface PromptCacheChange {
...
export interface PromptCacheObservationStart {
...
const MIN_CACHE_BREAK_TOKEN_DROP = 1000;
...
export function collectPromptCacheToolNames(tools: { name?: string }[]): string[] {
