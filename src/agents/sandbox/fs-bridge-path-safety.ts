...
import { type BoundaryFileOpenResult, openBoundaryFile } from "./fs-bridge-path-safety.runtime.js";
import type { SandboxFsMount, SandboxResolvedFsPath } from "./fs-paths.js";
...
export interface PinnedSandboxEntry {
  mountRootPath: string;
  relativeParentPath: string;
  basename: string;
}

export interface AnchoredSandboxEntry {
  canonicalParentPath: string;
  basename: string;
}

export interface PinnedSandboxDirectoryEntry {
  mountRootPath: string;
  relativePath: string;
}
