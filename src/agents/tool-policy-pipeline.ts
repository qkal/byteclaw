...
export function buildDefaultToolPolicyPipelineSteps(params: {
  ...
  return [
    ...
    { label: "tools.allow", policy: params.globalPolicy, stripPluginOnlyAllowlist: true },
    {
    ...
    { label: "group tools.allow", policy: params.groupPolicy, stripPluginOnlyAllowlist: true },
  ];
}
