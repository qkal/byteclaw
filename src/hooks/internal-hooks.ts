...
export interface AgentBootstrapHookContext {
  workspaceDir: string;
...
export interface GatewayStartupHookContext {
  cfg?: OpenClawConfig;
  deps?: CliDeps;
  workspaceDir?: string;
}
...
interface MessageEnrichedBodyHookContext {
  /** Sender identifier (e.g., phone number, user ID) */
  from?: string;
  /** Recipient identifier */
  to?: string;
...
export interface SessionPatchHookContext {
