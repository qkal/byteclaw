...
describe("matchesExecAllowlistPattern", () => {
  it.each([
    { expected: false, pattern: "", target: "/tmp/tool" },
    { expected: false, pattern: "   ", target: "/tmp/tool" },
    { expected: true, pattern: "/tmp/tool", target: "/tmp/tool" },
  ...
  it.each([
    { expected: true, pattern: "/tmp/*/tool", target: "/tmp/a/tool" },
    { expected: false, pattern: "/tmp/*/tool", target: "/tmp/a/b/tool" },
    { expected: true, pattern: "/tmp/**/tool", target: "/tmp/a/b/tool" },
