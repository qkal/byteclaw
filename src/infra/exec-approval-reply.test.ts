  ...
  it("builds shared exec approval action descriptors and interactive replies", () => {
    ...
    expect(
      ...
      blocks: [
        {
          buttons: [
            { label: "Allow Once", style: "success", value: "/approve req-1 allow-once" },
            { label: "Allow Always", style: "primary", value: "/approve req-1 allow-always" },
            { label: "Deny", style: "danger", value: "/approve req-1 deny" },
          ],
          type: "buttons",
        },
      ],
