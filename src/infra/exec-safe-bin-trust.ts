...
interface TrustedSafeBinDirsParams {
  baseDirs?: readonly string[];
  extraDirs?: readonly string[];
}

interface TrustedSafeBinPathParams {
  resolvedPath: string;
  trustedDirs?: ReadonlySet<string>;
}

interface TrustedSafeBinCache {
  key: string;
  dirs: Set<string>;
}

export interface WritableTrustedSafeBinDir {
  dir: string;
