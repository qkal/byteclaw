import { type LookupAddress, lookup as dnsLookupCb } from "node:dns";
...
export interface PinnedHostnameOverride {
  hostname: string;
  addresses: string[];
}
...
export async function resolvePinnedHostnameWithPolicy(
  ...
  return {
    addresses,
    hostname: normalized,
    lookup: createPinnedLookup({ addresses, hostname: normalized }),
  };
}
