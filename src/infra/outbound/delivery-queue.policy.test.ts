...
describe("delivery-queue policy", () => {
  ...
  describe("computeBackoffMs", () => {
    it.each([
      { expected: 0, retryCount: 0 },
      { expected: 5000, retryCount: 1 },
      { expected: 25_000, retryCount: 2 },
      { expected: 120_000, retryCount: 3 },
      { expected: 600_000, retryCount: 4 },
      { expected: 600_000, retryCount: 5 },
    ] as const)(
