...
describe("resolveGatewayService", () => {
  it.each([
    { label: "LaunchAgent", loadedText: "loaded", platform: "darwin" as const },
    { label: "systemd", loadedText: "enabled", platform: "linux" as const },
    { label: "Scheduled Task", loadedText: "registered", platform: "win32" as const },
