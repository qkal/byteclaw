...
import { type OpenClawConfig, clearRuntimeConfigSnapshot } from "../config/config.js";
  ...
  it(
    ...
    async () => {
      ...
      try {
        ...
        logCliBackendLiveStep("agent-request:start", { nonce, sessionKey });
        ...
        if (modelSwitchTarget) {
          ...
          logCliBackendLiveStep("agent-resume:start", { resumeNonce, sessionKey });
