...
import { type ConfigSchemaResponse, lookupConfigSchema } from "../../config/schema.js";
...
function summarizeConfigValidationIssues(issues: readonly ConfigValidationIssue[]): string {
...
export const configHandlers: GatewayRequestHandlers = {
  ...
  "config.openFile": async ({ params, respond, context }) => {
    ...
    try {
      ...
      respond(
        true,
        { error: "failed to open config file", ok: false, path: configPath },
        undefined,
      );
    }
  },
