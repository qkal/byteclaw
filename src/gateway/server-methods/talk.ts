...
import { type TtsDirectiveOverrides, synthesizeSpeech } from "../../tts/tts.js";
...
interface TalkSpeakErrorDetails {
...
export const talkHandlers: GatewayRequestHandlers = {
  ...
  "talk.speak": async ({ params, respond }) => {
    ...
    try {
      ...
      respond(false, undefined, talkSpeakError("synthesis_failed", formatForLog(error)));
    }
  },
};
