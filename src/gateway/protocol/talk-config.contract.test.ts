...
interface SelectionContractCase {
  id: string;
...
interface TalkConfigContractFixture {
...
const fixtures = JSON.parse(fs.readFileSync(fixturePath, "utf8")) as TalkConfigContractFixture;
