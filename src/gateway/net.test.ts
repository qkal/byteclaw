...
describe("resolveHostName", () => {
  it.each([
    { expected: "localhost", input: "localhost:18789" },
    { expected: "127.0.0.1", input: "127.0.0.1:18789" },
    { expected: "::1", input: "[::1]:18789" },
    { expected: "::1", input: "::1" },
...
describe("isSecureWebSocketUrl", () => {
  it.each([
    // wss:// always accepted
    { expected: true, input: "wss://127.0.0.1:18789" },
    { expected: true, input: "wss://localhost:18789" },
    { expected: true, input: "wss://remote.example.com:18789" },
    { expected: true, input: "wss://192.168.1.100:18789" },
    // ws:// loopback accepted
    { expected: true, input: "ws://127.0.0.1:18789" },
    { expected: true, input: "ws://localhost:18789" },
    { expected: true, input: "ws://[::1]:18789" },
    { expected: true, input: "ws://127.0.0.42:18789" },
    // ws:// private/public remote addresses rejected by default
    { expected: false, input: "ws://10.0.0.5:18789" },
    { expected: false, input: "ws://10.42.1.100:18789" },
    { expected: false, input: "ws://172.16.0.1:18789" },
    { expected: false, input: "ws://172.31.255.254:18789" },
    { expected: false, input: "ws://192.168.1.100:18789" },
    { expected: false, input: "ws://169.254.10.20:18789" },
    { expected: false, input: "ws://100.64.0.1:18789" },
    { expected: false, input: "ws://[fc00::1]:18789" },
    { expected: false, input: "ws://[fd12:3456:789a::1]:18789" },
    { expected: false, input: "ws://[fe80::1]:18789" },
    { expected: false, input: "ws://[::]:18789" },
    { expected: false, input: "ws://[ff02::1]:18789" },
    // ws:// public addresses rejected
    { expected: false, input: "ws://remote.example.com:18789" },
    { expected: false, input: "ws://1.1.1.1:18789" },
    { expected: false, input: "ws://8.8.8.8:18789" },
    { expected: false, input: "ws://203.0.113.10:18789" },
    // Invalid URLs
    { expected: false, input: "not-a-url" },
    { expected: false, input: "" },
    { expected: true, input: "http://127.0.0.1:18789" },
    { expected: true, input: "https://127.0.0.1:18789" },
    { expected: true, input: "https://remote.example.com:18789" },
    { expected: false, input: "http://remote.example.com:18789" },
